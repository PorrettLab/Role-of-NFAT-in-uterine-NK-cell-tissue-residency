...
# Save the corrected count matrix for use in downstream analyses
...
## HC18_CD45
```{r}
sc = load10X("/cell_ranger_pipepline_analysis/HC18sortedCD45/outs/")
...
DropletUtils:::write10xCounts("soupX_filtered/HC18_CD45_soupX_filtered", corrected.count.matrix)
...
## UTX01_BX02
```{r}
sc = load10X("/cell_ranger_pipepline_analysis/UTx01_Bx02/outs/")
...
DropletUtils:::write10xCounts("soupX_filtered/UTx01_Bx02_soupX_filtered", corrected.count.matrix)
...
## UTX01_BX03
```{r}
sc = load10X("/cell_ranger_pipepline_analysis/UTX01_BX03/outs/")
...
DropletUtils:::write10xCounts("soupX_filtered/UTx01_Bx03_soupX_filtered", corrected.count.matrix)
...
## UTX01_BX04
```{r}
sc = load10X("/cell_ranger_pipepline_analysis/UTX01_BX04/outs/")
...
DropletUtils:::write10xCounts("soupX_filtered/UTx01_Bx04_soupX_filtered", corrected.count.matrix)
...
## UTX01_BX05
```{r}
sc = load10X("/cell_ranger_pipepline_analysis/UTx01_Bx05/outs/")
...
DropletUtils:::write10xCounts("soupX_filtered/UTx01_Bx05_soupX_filtered", corrected.count.matrix)
...
## UTX02_BX02
```{r}
sc = load10X("/cell_ranger_pipepline_analysis/UTx02_Bx02/outs/")

str(sc) 
sc = autoEstCont(sc)
corrected.count.matrix = adjustCounts(sc)
dim(corrected.count.matrix)
DropletUtils:::write10xCounts("soupX_filtered/UTx02_Bx02_soupX_filtered", corrected.count.matrix)
...
## UTX03_BX02
```{r}
sc = load10X("/cell_ranger_pipepline_analysis/UTx03_Bx02/outs/")
...
DropletUtils:::write10xCounts("soupX_filtered/UTx03_Bx02_soupX_filtered", corrected.count.matrix)
...
## UTX03_BX03
```{r}
sc = load10X("/cell_ranger_pipepline_analysis/UTx03_Bx03/outs/")
...
DropletUtils:::write10xCounts("soupX_filtered/UTx03_Bx03_soupX_filtered", corrected.count.matrix)
...
## UTx04_Bx02
```{r, eval=FALSE}
sc = load10X("/cell_ranger_pipepline_analysis/UTx04_Bx02/outs/")

str(sc) 
sc = autoEstCont(sc)
corrected.count.matrix = adjustCounts(sc)
dim(corrected.count.matrix)
DropletUtils:::write10xCounts("soupX_filtered/UTx04_Bx02_soupX_filtered", corrected.count.matrix)
...
## UTx05_Bx03
```{r}
sc = load10X("/cell_ranger_pipepline_analysis/UTx05_Bx03/outs/")
...
DropletUtils:::write10xCounts("soupX_filtered/UTx05_Bx03_soupX_filtered", corrected.count.matrix)
